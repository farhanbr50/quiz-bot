...
async def send_question(chat_id):
    ...
    # HAR QUESTION MEIN "MAHAKAL QUIZ" LIKHA HOGA
    question_text = (
        f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
        f"           🔱 MAHAKAL QUIZ 🔱\n"
        f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
...
async def stop_quiz(message: types.Message):
    ...
    if chat_id in GROUP_GAMES and GROUP_GAMES[chat_id].get("active"):
        ...
        await message.answer(
            ...
            f"Quiz has been stopped. Type /quiz on to start again!"
        )
    else:
...
async def main():
    ...
    if RENDER_URL:
        ...
        print("⚠️ No webhook URL set, using polling mode")
